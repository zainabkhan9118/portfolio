...
export default function KNDTerminal() {
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="space-y-6 text-lg md:text-xl leading-relaxed">
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-8">
                    <div className="border border-primary p-4 hover:bg-primary/10 transition-colors">
                    ...
                    <div className="border border-primary p-4 hover:bg-primary/10 transition-colors md:col-span-2">
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="space-y-12">
                {projects.map((project, idx) => (
                    <div key={idx} className="knd-box p-6 relative group hover:shadow-[0_0_15px_var(--primary)] transition-all">
    ...
    const TerminalSkills = () => (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {skills.map((cat, idx) => (
                    <div key={idx} className="border border-primary p-4 hover:bg-primary/5 transition-colors">
                        <div className="flex items-center gap-3 mb-4 border-b border-primary/30 pb-2">
                            {/* Re-using icon here might require passing component, but simpler to omit or just use name */}
        ...
        <div className="space-y-8 animate-in fade-in duration-500 max-w-4xl mx-auto">
            ...
            <div className="knd-box p-8 md:p-12 text-center space-y-8">
                ...
                <div className="flex flex-col md:flex-row justify-center flex-wrap gap-4 md:gap-6 mt-8">
                    <a href="mailto:zainabiqbal653@gmail.com" className="flex items-center justify-center gap-3 px-6 py-4 bg-primary text-black font-bold text-lg md:text-xl hover:bg-white transition-colors">
                        <Mail /> EMAIL TRANSMISSION
                    </a>
                    <a href="tel:03431159190" className="flex items-center justify-center gap-3 px-6 py-4 border-2 border-primary text-primary font-bold text-lg md:text-xl hover:bg-primary/20 transition-colors">
                        <Phone /> 0343-1159190
                    </a>
                    <a href="https://github.com/zainabkhan9118" target="_blank" className="flex items-center justify-center gap-3 px-6 py-4 border-2 border-primary text-primary font-bold text-lg md:text-xl hover:bg-primary/20 transition-colors">
                        <Github /> GITHUB UPLINK
                    </a>
                    <a href="https://www.linkedin.com/in/zainab-iqbal-3a0216241" target="_blank" className="flex items-center justify-center gap-3 px-6 py-4 border-2 border-primary text-primary font-bold text-lg md:text-xl hover:bg-primary/20 transition-colors">
    ...
    return (
        <div className="h-screen w-full bg-black text-primary font-knd relative overflow-hidden flex flex-col">
            {/* Global Effects */}
            ...
            <div className="relative z-10 w-full h-full flex-1 p-2 md:p-6 flex flex-col max-w-7xl mx-auto">
                ...
                {/* Header / Top Bar */}
                <header className="flex justify-between items-end border-b-4 border-primary pb-2 mb-4 shrink-0">
                    <div className="flex flex-col">
                        <h1 className="text-3xl md:text-5xl font-bold text-glow tracking-tighter cursor-pointer" onClick={() => setState("MENU")}>
                            OPERATIVE ZAINAB
                        </h1>
                ...
                <main className="flex-1 border-2 border-primary knd-box relative overflow-hidden flex flex-col shadow-[0_0_20px_rgba(74,246,38,0.2)]">
                    ...
                    {state === "CONTENT" && (
                        <div className="relative w-full h-full flex flex-col">
                            ...
                            <div className="flex-1 overflow-y-auto p-4 md:p-6 pb-20">
                                {/* Background overlay specific to content */}
                                ...
                                <div className="max-w-5xl mx-auto space-y-12">
                                    ...
                                    {activeContent === "TESTIMONIALS" && <div className="text-center mt-20 text-2xl">&gt;&gt; DATA CORRUPTED (COMING SOON)</div>}
                                </div>
                            </div>
                        </div>
                    )}
